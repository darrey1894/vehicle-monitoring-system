...
private DPFPVerification Verificador = DPFPGlobal.getVerificationFactory().createVerification();
  ...
  // dateCheck();
    ...
    private void initComponents() {
        ...
        car_plate = new javax.swing.JLabel();
        ...
        jPanel3.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 500, 340, 60));
        ...
        jPanel3.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 30, -1, -1));
        ...
        jPanel3.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, -1, -1));
        ...
        fullname.setText("XXXXXXXXXXX");
        jPanel3.add(fullname, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 280, 280, 20));
        ...
        driver_id.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        driver_id.setForeground(new java.awt.Color(255, 255, 255));
        driver_id.setText("XXXXXXXXXXX");
        jPanel3.add(driver_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 310, 280, 20));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(204, 255, 255));
        jLabel6.setText("DRIVER ID");
        jPanel3.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 310, -1, -1));

        jLabel1.setBackground(new java.awt.Color(204, 255, 255));
        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(204, 0, 0));
        jLabel1.setText("FINGER PRINT ");
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, 150, 20));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(204, 0, 0));
        jLabel4.setText("PASSPORT");
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 240, 100, 20));

        status1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jPanel3.add(status1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 350, 235, 27));

        prompt.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        prompt.setForeground(new java.awt.Color(255, 255, 0));
        jPanel3.add(prompt, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 300, 248, 27));

        HomeButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_Return_48px.png"))); // NOI18N
        HomeButton.setToolTipText("PREVIOUS PAGE");
        HomeButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                HomeButtonActionPerformed(evt);
            }
        });
        jPanel3.add(HomeButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 500, 110, 60));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(204, 255, 255));
        jLabel8.setText("CAR PLATE NUMBER");
        jPanel3.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 390, -1, -1));

        car_plate.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        car_plate.setForeground(new java.awt.Color(255, 255, 255));
        car_plate.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        car_plate.setText("XX 123 XX");
        jPanel3.add(car_plate, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 410, 290, 50));

        car_type.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        car_type.setForeground(new java.awt.Color(255, 255, 255));
        car_type.setText("XXXXXXXXXXX");
        jPanel3.add(car_type, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 340, 280, -1));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(204, 255, 255));
        jLabel9.setText("DATE:");
        jPanel3.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 70, -1, -1));

        date.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        date.setForeground(new java.awt.Color(255, 255, 255));
        date.setText("sfdh");
        jPanel3.add(date, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 50, 230, 50));

        time.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        time.setForeground(new java.awt.Color(255, 255, 255));
        time.setText("sfdh");
        jPanel3.add(time, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 130, 230, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(204, 255, 255));
        jLabel10.setText("TIME:");
        jPanel3.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 140, -1, -1));

        jLabel11.setText("IN");
        jPanel3.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 200, 30, 20));

        jLabel12.setText("OUT");
        jPanel3.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 200, 40, 20));
        ...
        jPanel3.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 500, 350, 60));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 204, 255));
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/SEC0417-testing-feat-slide_900px.jpg"))); // NOI18N
        jLabel7.setToolTipText("");
        jPanel3.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -20, 800, 610));
		...
		capturer.addReaderStatusListener(new DPFPReaderStatusAdapter() {
			public void readerConnected(final DPFPReaderStatusEvent e) {
				SwingUtilities.invokeLater(new Runnable() {	public void run() {
					setPrompt("Scan the Driver's fingerprint.");
				}});
			}
...
if (result.isVerified()){
 ...
 JOptionPane ops1 = new JOptionPane("DATA RETRIEVE!",JOptionPane.INFORMATION_MESSAGE);
    ...
    driver_id.setText(rs.getString("DRIVER_ID"));
    car_type.setText(rs.getString("CAR_TYPE"));
    car_plate.setText(rs.getString("PLATE_NO"));
...
return template;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     //ByteArrayInputStream datosHuella = new ByteArrayInputStream(template.serialize());
      ...
      String sql = "INSERT INTO  car_status (NAME , DRIVER_ID ,CAR_TYPE ,PLATE_NO, date, time, status ) VALUES (?,?,?,?,?,?,?)";
            try{
          pstmt = conn.prepareStatement(sql);
          
            pstmt.setString(1, fullname.getText());
            pstmt.setString(2, driver_id.getText());
            pstmt.setString(3, car_type.getText());
            pstmt.setString(4, car_plate.getText());
            pstmt.setString(5, date.getText());
            pstmt.setString(6, time.getText());
            pstmt.setString(7, jLabel11.getText());
          pstmt.execute();
          JOptionPane.showMessageDialog(null,"CAR SUCCEFULLY CHECK IN");
      }catch(Exception e){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
          ...
          pstmt = conn.prepareStatement(sql);
            ...
            pstmt.setString(5, date.getText());
            pstmt.setString(6, time.getText());
            pstmt.setString(7, jLabel12.getText());
          pstmt.execute();
          JOptionPane.showMessageDialog(null,"CAR SUCCEFULLY CHECK OUT");
      }catch(Exception e){
          JOptionPane.showMessageDialog(null , e);
      }
    ...
    private javax.swing.JLabel car_plate;
